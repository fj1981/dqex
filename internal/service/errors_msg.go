...
var svcErrMap = map[string]map[string]string{
	"zh": {
		...
		svcAIToolListDBs:     "构建工具 list_databases 失败",
		svcAIToolListTables:  "构建工具 list_tables 失败",
		svcAIToolGetSchema:   "构建工具 get_schema 失败",
	...
	"en": {
		...
		svcAIToolListDBs:     "failed to build tool list_databases",
		svcAIToolListTables:  "failed to build tool list_tables",
		svcAIToolGetSchema:   "failed to build tool get_schema",
